...
competitive_df = pd.read_csv(
    RESULTS_DIR / "competitive_training_results.csv"
)

cooperative_df = pd.read_csv(
    RESULTS_DIR / "cooperative_training_results.csv"
)
...
competitive_solar_q = np.load(
    RESULTS_DIR / "competitive_solar_qtable.npy"
)

competitive_wind_q = np.load(
    RESULTS_DIR / "competitive_wind_qtable.npy"
)

cooperative_solar_q = np.load(
    RESULTS_DIR / "cooperative_solar_qtable.npy"
)

cooperative_wind_q = np.load(
    RESULTS_DIR / "cooperative_wind_qtable.npy"
)
